...
1. Clone este repositório para o seu computador:
    ``` shell
     git clone https://github.com/ViMayer/Java-LeitorDeTxt.git
    ```
2. Selecione o caminho correto da pasta 
    ``` shell
     cd exemplo-de-comando/local-da-pasta/Java-LeitorDeTxt
    ```
...
4. Pós compilação, inicie o projeto
    ``` shell
     java -cp src LeitorDeTxt
    ```
5. Observe enquanto os conteúdos do arquivo são exibidos no console
